...
const Upload = () => {
  const courses = useSelector(state => state.courses.data) // select courses from state
  const courseId = courses[0].id // get id of first course
  const moduleId = courses[0].modules[0].id // get id of first module in first course
  const [form] = Form.useForm()
